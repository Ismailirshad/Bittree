...
//   }
//   return (
//     <div className=' bg-[#2cae6d] min-h-screen grid grid-cols-2'>
  ...
  return (
    <div className='bg-[#2cae6d] min-h-screen grid grid-cols-2'>
      <div className="col-1 flex flex-col mt-20 items-center justify-center gap-3">
        ...
        <div className='flex w-110 flex-col gap-5 my-3 text-start'>
          ...
          <div className='mx-4'>
            <input 
              ...
              value={handle} 
              className='p-1 border rounded-md text-md font-semibold focus:outline-pink-500 text-center bg-slate-50 w-80' 
              type="text" 
        ...
        <div className='flex w-110 flex-col gap-5 my-3 text-start'>
          <h1 className='font-semibold text-2xl'>Step 2: Add Links</h1>
          <div className='mx-4 gap-2 flex flex-col'>
            {links.map((item, index) => (
              <div className='flex w-80 flex-col gap-2 my-2' key={index}>
                <input
                  onChange={e => handleLinkTextChange(index, e.target.value)}
                  value={item.linktext}
                  className="p-1 border rounded-md text-md font-semibold focus:outline-pink-500 text-center bg-slate-50"
            ...
            <button onClick={addLink} className='bg-black py-1 text-green-400 font-bold rounded-md'>Add Link</button>
          </div>
        </div>
        ...
        <div className='flex w-110 flex-col gap-5 my-3 text-start'>
          ...
          <div className='mx-4 gap-2 w-80 flex flex-col'>
            <input 
              ...
              className='p-1 border rounded-md text-md font-semibold focus:outline-pink-500 w-full text-center bg-slate-50' 
              type="text" 
      ...
      <div className="col-2 flex items-center justify-center">
        <Image 
          ...
          src="https://myfreewilljourney.files.wordpress.com/2021/06/linktree-logo-0.png?w=1200" 
          alt="img" 
        />
        <ToastContainer />
      </div>
