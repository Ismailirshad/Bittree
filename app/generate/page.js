...
function Generate() {
  ...
  return (
    <div className=' bg-[#2cae6d] min-h-screen grid grid-cols-2'>
      ...
      <div className="col-1 flex flex-col items-center justify-center gap-3">
        ...
        <div className='flex w-110 flex-col gap-5 my-2'>
          ...
          <div className='mx-4 gap-2 flex flex-col'>
            ...
            <button onClick={() => addLink()} className='bg-black  text-white font-bold rounded-full'>AddLink</button>
          </div>
        </div>
        ...
        <div className='flex w-110 flex-col gap-5 my-3 text-start'>
          ...
          <div className='mx-4 gap-2 flex flex-col'>
            ...
            <button onClick={submitLink} className='bg-black text-white font-bold rounded-full p-1 px-3'>Create your BitLink</button>
